...
class SectionKeypad extends StatefulWidget {
  final SectionProvider sectionProvider;

  SectionKeypad({@required this.sectionProvider});

  @override
  _SectionKeypadState createState() => _SectionKeypadState();
}

class _SectionKeypadState extends State<SectionKeypad> {
                ...
                Expanded(
                  child: CustomKeypadButton(
                    onPressed: () async {
                      ...
                      if (!await widget.sectionProvider.currentUserChange(
